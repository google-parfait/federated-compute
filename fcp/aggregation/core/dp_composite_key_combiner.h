...
#ifndef FCP_AGGREGATION_CORE_DP_COMPOSITE_KEY_COMBINER_H_
#define FCP_AGGREGATION_CORE_DP_COMPOSITE_KEY_COMBINER_H_
...
#endif  // FCP_AGGREGATION_CORE_DP_COMPOSITE_KEY_COMBINER_H_
