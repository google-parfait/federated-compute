...
#ifndef FCP_AGGREGATION_PROTOCOL_OUTPUT_CHECKPOINT_BUILDER_H_
#define FCP_AGGREGATION_PROTOCOL_OUTPUT_CHECKPOINT_BUILDER_H_
...
#endif  // FCP_AGGREGATION_PROTOCOL_OUTPUT_CHECKPOINT_BUILDER_H_
