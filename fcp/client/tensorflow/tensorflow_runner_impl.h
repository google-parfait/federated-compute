 ...
 */
#ifndef FCP_CLIENT_TENSORFLOW_TENSORFLOW_RUNNER_IMPL_H_
#define FCP_CLIENT_TENSORFLOW_TENSORFLOW_RUNNER_IMPL_H_
...
class TensorflowRunnerImpl : public TensorflowRunner {
 public:
