...
TEST_F(ExampleQueryPlanEngineTest, SingleQueryDirectDataUploadTaskSucceeds) {
  ...
  std::string example_1_str = "example_1";
  std::string example_2_str = "example_2";
  ...
  num_examples_ = 2;
  example_bytes_ = example_1_str.size() + example_2_str.size();
...
TEST_F(ExampleQueryPlanEngineTest, TwoQueryDirectDataUploadTaskSucceeds) {
  ...
  std::string example_1_str = "example_1";
  std::string example_2_str = "example_2";
  std::string example_3_str = "example_3";
  std::string example_4_str = "example_4";
...
TEST_F(ExampleQueryPlanEngineTest, DirectQueryInsufficientData) {
  ...
  *example_query =
  ...
  num_examples_ = 1;
  example_bytes_ = example_1_str.size();
...
TEST_F(PrivacyIdSplittingTest, NonRotatingPrivacyIdWithV2FlagEnabled) {
  ...
  Initialize();
  // Remove the windowing schedule to make this a non-rotating privacy ID
  // config.
  client_only_plan_.mutable_phase()
      ->mutable_example_query_spec()
      ->mutable_privacy_id_config()
      ->clear_windowing_schedule();
  ...
  EXPECT_THAT(result.federated_compute_checkpoints,
              testing::Each(HasPrivacyIdTensor()));
  EXPECT_THAT(result.federated_compute_checkpoints[0],
              HasEventTimeRange(CreateEventTimeRange(
