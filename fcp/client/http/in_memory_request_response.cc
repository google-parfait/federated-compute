...
absl::StatusOr<InMemoryHttpResponse> PerformRequestInMemory(
  ...
  FCP_ASSIGN_OR_RETURN(
      auto result, PerformRequestsInMemory(http_client, interruptible_runner,
                                           std::move(requests),
...
FetchResourcesInMemory(HttpClient& http_client,
  ...
  auto resource_fetch_result = PerformRequestsInMemory(
